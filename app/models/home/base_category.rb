...
#
# class MyCategory < Home::BaseCategory
#   def title_template
#     'Your title'
#   end
#
...
module Home
  class BaseCategory
    ...
    def valid_title_template?
      I18n.exists?(title_template)
    end

    def ensure_title_template?
      return if valid_title_template?

      raise ConfigurationError, "Invalid I18n key for #{title_template}"
    end
